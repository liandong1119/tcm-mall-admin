    ...
    <div class="review-container">
        <el-card class="box-card">
            ...
            <el-table :data="reviewList" v-loading="loading" style="width: 100%">
                <el-table-column prop="name" :label="$t('review.productName')" min-width="200">
                ...
                <el-table-column prop="startTime" :label="$t('review.createTime')" width="180"/>
...
import {getReviewList, replyReview} from "@/api/review.js";
...
const fetchReviews = async () => {
    ...
    try {
        const requestParam = {
            ...
            level: searchForm.value.rating,
            name: searchForm.value.productName
        }
        const {list, total: totalCount} = await getReviewList(requestParam)
        ...
        if (valid) {
            ...
            try {
                const commentReply = {
                    ...
                    goodsId: currentReview.value.productId,
                    reply: replyForm.value.content
                }
                await replyReview(commentReply)
